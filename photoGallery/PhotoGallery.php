...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="dvangel.jpg"/>
    </head>
    <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
                <div class="container">
                    <a class="navbar-brand" href="../index.php"><img src="DVC.png"  class="logo" >Rea-Connekt</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link active" href="../DvCorpDashbord.php">Home</a>
                            </li>
                            <li class="nav-item">
...
<!--                        <p>The World's greatest architectural achievements both Past, Present and Furure.</p>-->
                        <hr>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="2.jpg">                        
                            <img src="2.jpg" alt="building" class="card-img-top">
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="1.jpg">                         
                            <img src="1.jpg" alt="building" class="card-img-top">
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="3.jpg">                         
                            <img src="3.jpg" alt="building" class="card-img-top">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="4.jpg">                               
                           <img src="4.jpg" alt="building" class="card-img-top">
                        </a>    
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="5.jpg">      
                           <img src="5.jpg" alt="building" class="card-img-top">
                        </a>   
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="6.jpg">    
                            <img src="6.jpg" alt="building" class="card-img-top">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="7.jpg">           
                            <img src="7.jpg" alt="building" class="card-img-top">
                        </a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="8.jpg">          
                            <img src="8.jpg" alt="building" class="card-img-top">
                        </a> 
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="9.jpg">         
                            <img src="9.jpg" alt="building" class="card-img-top">
                        </a>   
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="10.jpg">              
                            <img src="10.jpg" alt="building" class="card-img-top">
                        </a>      
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="11.jpg">               
                            <img src="11.jpg" alt="building" class="card-img-top">
                        </a>       
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="12.jpg">             
                            <img src="12.jpg" alt="building" class="card-img-top">
                        </a>      
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="13.jpg">                  
                            <img src="13.jpg" alt="building" class="card-img-top">
                        </a>      
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="14.jpg">                 
                            <img src="14.jpg" alt="building" class="card-img-top">
                        </a>        
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <a class="lightbox" href="15.jpg">                  
                            <img src="15.jpg" alt="building" class="card-img-top">
                        </a>        
                    </div>
                </div>
